...
@implementation SubCategoryTileDataSource{
...
-(void)initDataArrayFromCoreData{
    ...
    SubCategoryCollectionViewController *sc = (SubCategoryCollectionViewController*)self.delegate;
    NSString *str = [NSString stringWithFormat:@"parent_id == %@", sc.aCategory.id];
