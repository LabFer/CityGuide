...
#define kCategoryLabelWidth 0
#define kCategoryLabelHieght 0
...
-(void)setScrollViewWidth:(CGFloat)width{
    _imageScrollingView = [[PPImageScrollingCellView alloc] initWithFrame:CGRectMake(0., kStartPointY, width, kScrollingViewHieght)];
    _imageScrollingView.delegate = self;
}
...
+ (NSString *)reuseId
{
    return kReusePlaceDetailPPImageScrollingTableViewCell;
}
